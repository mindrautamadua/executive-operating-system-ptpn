    ...
    <div className="flex h-dvh min-w-0 overflow-hidden bg-[var(--bg-app)]">
      ...
      <main className="scroll-thin min-w-0 flex-1 overflow-y-auto">
        ...
        <div className="flex flex-col gap-3 px-5 pb-5">
          ...
          <div className="grid auto-rows-[minmax(250px,auto)] grid-cols-1 gap-3 lg:grid-cols-2 xl:grid-cols-[minmax(0,36fr)_minmax(0,36fr)_minmax(0,28fr)]">
            <PlasmaWelfareTrend />
            <PsrProgress />
            <TjslAllocation />
          </div>

          <div className="grid auto-rows-[minmax(250px,auto)] grid-cols-1 gap-3 lg:grid-cols-2 xl:grid-cols-[minmax(0,32fr)_minmax(0,36fr)_minmax(0,32fr)]">
            <CommunityGrievance />
